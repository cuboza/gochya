...
var (
	ErrChallengeNotFound = errors.New("device enrollment challenge not found")
	ErrChallengeUsed     = errors.New("device enrollment challenge already used")
	ErrDeviceConflict    = errors.New("device is already registered with another key or state")
