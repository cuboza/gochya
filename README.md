...
> **Виртуальный питомец для носимых устройств** (Galaxy Watch / Apple Watch + companion-апп), с записью реальных ударов, бридингом, синхронизацией с активностью владельца и PvP-чемпионатами.
