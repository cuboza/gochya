...
|---|---|---|---|---|---|---|---|
| **Fire** | 1.0 | 0.67 | 1.5 | 1.0 | 0.91 | 0.91 | 1.1 |
| **Water** | 1.5 | 1.0 | 1.0 | 0.67 | 0.91 | 0.91 | 1.1 |
| **Earth** | 0.67 | 1.0 | 1.0 | 1.5 | 0.91 | 0.91 | 1.1 |
| **Air** | 1.0 | 1.5 | 0.67 | 1.0 | 0.91 | 0.91 | 1.1 |
...
1. **Круг базовых стихий** (1.5 / 0.67 обратно) — тот самый, что заявлен в
   `CORE_FORMULAS.md` §5.3: `Fire > Earth > Air > Water > Fire`.
2. **Противостояние Light ↔ Dark** — взаимные 1.5. Бонус симметричен, поэтому на
   баланс не влияет: он делает эти дуэли зрелищнее, не давая преимущества ни одной стороне.
3. **Треугольник тиров:** `базовые > Arcane > Light/Dark > базовые` (1.1 / 0.91 обратно).
   Он и даёт контру редким стихиям.
...
Это `CORE_SPEC.md` §5 инвариант №10; проверяется тестом, а не чтением таблицы.

| Стихия | Нетто | Контрится |
|---|---|---|
| Fire / Water / Earth / Air | −0.03 | своя пара по кругу + Light + Dark |
| Light / Dark | +0.08 | друг другом + Arcane |
| Arcane | −0.05 | всеми четырьмя базовыми |

Разброс нетто **0.136**. Light и Dark чуть выше нуля осознанно: это редкие стихии,
и они дороже достаются в бридинге.

> **Что было не так до правки.** Arcane бил всех на 1.2 и получал от всех 0.8 —
> его не контрил никто (нетто +0.34), Air не контрился никем, кроме Arcane, а разброс
> составлял 0.52. В игре, где стихия — наследуемый ген и предмет бридинг-меты,
> это схлопывало мету к двум стихиям. Кроме того, таблица противоречила собственному
> тексту: `Earth→Air` стояло 0.67, хотя круг заявлял обратное.
